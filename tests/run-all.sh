...
FAILED=0
for t in e2e-portal e2e-mereni e2e-offline e2e-magic e2e-push e2e-quiet e2e-slovnicek api-attendees google-forms-attendees privacy-public-data security-regressions sraz-asset-versions e2e-sraz archived-groups; do
  echo "===== $t ====="
  node "$t.js" || FAILED=1
done
exit $FAILED
